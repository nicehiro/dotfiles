...
// Yahr Eldritch quick app selector.
...
ShellRoot {
    ...
    // Yahr Eldritch palette
    readonly property color paper:   "#212337"  // cream background
    readonly property color ink:     "#ebfafa"  // lotusInk1
    readonly property color inkDeep: "#c8d7f0"  // lotusInk2
    readonly property color sumi:    "#7081d0"  // lotusGray
    readonly property color indigo:  "#04d1f9"  // lotusBlue4
    readonly property color seal:    "#f265b5"  // lotusRed
    readonly property color wash:    "#323449"  // a touch darker than paper, for circle fills
    ...
    PanelWindow {
        ...
        color: Qt.rgba(0.129, 0.137, 0.216, 0.97)
        WlrLayershell.layer: WlrLayer.Overlay
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.Exclusive
        WlrLayershell.namespace: "quickshell-yahr-quickapps"
        ...
        Text {
            ...
            text: "静"
            color: Qt.rgba(0.439, 0.506, 0.816, 0.10)
        ...
        Item {
            ...
            Rectangle {
                ...
                color: "transparent"
                border.color: Qt.rgba(0.643, 0.549, 0.949, 0.18)
                border.width: 1
            }
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        color: Qt.rgba(0.643, 0.549, 0.949, 0.07)  // indigo, very faint
                    ...
                    Rectangle {
                        ...
                        border.color: parent.focused ? root.ink : Qt.rgba(0.643, 0.549, 0.949, 0.35)
                        border.width: 1
